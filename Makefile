...
#
# Usage: (from the root directory of project)
...
## rules to download raw fatality data - grouped by factor involvement
...
## rules to download raw injury data - grouped by factor involvement
...
# generate the distraction involved driving bar plot
...
# generate the speeding involved driving bar plot
...
# generate the drug/alcohol involved driving bar plot
...
# summarise the distraction involce driving over the decade
...
# summarise the speeding involved driving over the decade
...
# summarise the drug/alcohol involved driving over the decade
